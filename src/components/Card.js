...
export default function Card({ tool }) {
	return (
		<a href={tool.url} target="_blank" className="group flex flex-col justify-between gap-y-10 cursor-pointer p-4 w-full sm:w-[49%] lg:w-[32.5%] rounded-xl border-[1px] border-gray-700 mb-4">
			<div>
