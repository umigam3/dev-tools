  ...
  return (
    <section id="about" class="bg-white dark:bg-gray-900">
        <div class="py-8 mx-auto max-w-screen-xl lg:py-16">
            <h1 class="mb-6 font-extrabold tracking-tight leading-none text-gray-900 text-3xl dark:text-white"><span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-purple-400">Why</span> I build this project?</h1>
